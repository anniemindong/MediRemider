...
import { TouchableOpacity, StyleSheet, Text, View, Alert, AsyncStorage } from 'react-native';
...
const LoginScreen = ({ navigation }: Props) => {
  ...
  const _onLoginPressed = async() => {
    ...
    try {
      ...
      if (result.success) {
        const obj1= JSON.stringify(result.token);
        await AsyncStorage.setItem('token',obj1);
      ...
      //  console.log(typeof obj22)
      //  console.log(typeof obj22.name)
